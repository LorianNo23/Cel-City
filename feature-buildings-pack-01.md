...
- [ ] Wire the restored GLB assets into the Roblox project as server building models.
- [ ] Add building config entries for the asset-backed house and shop.
- [ ] Add a small prototype client GUI to select the active building.
